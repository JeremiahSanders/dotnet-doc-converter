...
module Markdown =
    type InlineNode(value : string) =
        ...
        static member ofString value = InlineNode value

    type BlockNode(nodes : InlineNode list) =
        member this.Nodes = nodes
        static member ofNode (node : InlineNode) = BlockNode [ node ]
        static member ofNodes (nodes : InlineNode list) = BlockNode nodes
    ...
    module Elements =
        ...
        module Inline =
            ...
            let private getCodeDelimiter (value : string) =
